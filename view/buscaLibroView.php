...
<html lang="es">
    ...
    <body>
        ...
        <div class="row">
            <form action="<?php echo $helper->url("facturas","buscaPorTitulo"); ?>" method="post" class="col-lg-12" id="libroForm">
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="<?php echo $helper->url("facturas","anadeLibro"); ?>" method="post" class="col-lg-12" >
